...
![Figura 1. Exibindo Aplicação Shiny Com Linha em Azul](./images/app_shiny_blue.jpeg)

![Figura 2. Exibindo Aplicação Shiny Com Linha em Vermelho](./images/app_shiny_red.jpeg)

10. Disponibilize os códigos (RMarkdown e Shiny) em uma plataforma de compartilhamento de códigos (sugestão GitHub)

    - Todos os códigos desse projeto podem ser acessado no [GitHub]("[income_democracy.xlsx](https://github.com/hugoadriao/estatistica_dados_faltantes_projeto_final)")
